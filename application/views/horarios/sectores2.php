...
<body>
	<main>
		...
		<div class="right_col" role="main">
            ...
            <div class="center">
				<ul class="pagination">
					<li><a  href="<?= base_url() ?>Vistas/vistaHorario1">«</a></li>
					<li><a href="<?= base_url() ?>Vistas/vistaHorario1">1</a></li>
					<li><a class="active">2</a></li>
					<li><a href="<?= base_url() ?>Vistas/vistaHorario3">3</a></li>
					<li><a href="<?= base_url() ?>Vistas/vistaHorario4">4</a></li>
                    <li><a href="<?= base_url() ?>Vistas/vistaHorario3">»</a></li>
				</ul>
			</div>
